...
app=NaN(1);  %%%%%%%%%%%%%%%Placeholder for the Matlab app
folder1='C:\Local Matlab Data\3.5Ghz Neighborhood Github Example';
cd(folder1)
addpath(folder1)
pause(0.1)
addpath('C:\Local Matlab Data\General_Terrestrial_Pathloss')  %%%%%%%%This is another Github repo
addpath('C:\Local Matlab Data\General_Movelist')  %%%%%%%%This is another Github repo
pause(0.1)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Model Inputs
rev_folder='C:\Local Matlab Data\3.5Ghz Neighborhood Github Example\Rev101'%%%%%%%Test Example
parallel_flag=0%1 %%%%%0 --> serial, 1 --> parallel (if you have parallel toolbox)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Step 3: Scrap the Data for each DPA: Neighborhood Distance and Move List size
